    ...
    return (
        <>
         <nav className="min-w-screen bg-gray-800 p-4 text-white select-none">
            {location.pathname !== '/dashboard' && <Link to="/dashboard"><img src={Back} alt="Back Icon" className=" h-12 w-12 p-2 rounded-full absolute top-6 hover:scale-110 hover:bg-gray-700 select-none"/></Link>}
            ...
            <div>
                <Link to="/" onClick={handleLogout}>
                    <img src={PowerOff} alt='Log Out icon' className='h-12 w-12 p-2 rounded-full scale-130 absolute top-6 right-6 hover:scale-140 hover:bg-gray-700 select-none'/>
                </Link>
